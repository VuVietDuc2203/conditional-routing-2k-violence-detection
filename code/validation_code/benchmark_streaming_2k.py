"""Reproducible one-camera 1440p30 / 8-FPS-analytics streaming benchmark.
...
TRACE_FIELDS = [
    "source_frame", "source_time_sec", "analyzed", "warmed_up", "total_ms", "deadline_miss",
...
def run_once(args: argparse.Namespace, repeat: int) -> dict[str, Any]:
    ...
    cap = make_capture(parse_source(args.source), args.width, args.height, args.source_fps)
    ...
    try:
        while True:
            ...
            record: dict[str, Any] = {
                "source_frame": frame_index, "source_time_sec": source_time, "analyzed": False,
